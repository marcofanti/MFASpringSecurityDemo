...
public class Login {
	private static Log log = LogFactory.getLog("Login");
	private static String userName = "amadmin";
	private static String password = "Welcome!";
	private static String baseUrl = "http://openam2.example.com:8080/"; // http://localhost:16000
	private static String loginUrl = baseUrl + "openam/json/realms/root/authenticate";
	private static String logoutUrl = baseUrl + "openam/json/realms/root/sessions?_action=logout";
	private static String sessionUrl = baseUrl + "openam/json/realms/root/sessions/?_action=getSessionInfo";

	public static void main(String [] args) {
		Login login = new Login();
		String tokenId = login.doLogin(userName, password);
		log.debug("tokenId = " + tokenId);
		log.debug(login.validateSession(tokenId, tokenId));
		log.debug(login.doLogout(tokenId));
	}
	...
	private String validateSession(String tokenId, String userTokenId) {
	...
	private String doLogout(String tokenId) {
        String userName = null;
        CloseableHttpClient client = HttpClients.createDefault();
